...
| Fliege | hier |
|---|---|
| ~50 Riechkanäle (Glomeruli) | 15 Marktmerkmale als rollierende z-Werte, je ein AN- und AUS-Kanal |
...
| Prüfungen | dazu 2 zufällige frühere Quartale ohne Lernen — **es zählt das schlechteste Ergebnis** |
...
| `thr_long`, `thr_short` | wie sicher sie sein muss, bevor sie handelt (Short startet vorsichtiger — SPY steigt langfristig) |
...
sie in `data/` ab; Ergebnisse landen in `results/`. Eine Zucht dauert ~40 s.
